...
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_GET_SOURCE3F)(
    ALuint sourceName, ALenum param, ALfloat* v1, ALfloat* v2, ALfloat* v3);
...
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_GET_SOURCE3I)(
...
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_BUFFER_DATA)(
    ALuint bufferName, ALenum format, const ALvoid* data, ALsizei size, ALuint freq);

typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_BUFFERF)(ALuint bid, ALenum param, ALfloat value);
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_BUFFER3F)(
...
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_GET_BUFFER3F)(
    ALuint bid, ALenum param, ALfloat* value1, ALfloat* value2, ALfloat* value3);
...
typedef ALAPI ALvoid(ALAPIENTRY* ALAPI_GET_BUFFER3I)(
...
typedef ALCAPI ALCdevice*(ALCAPIENTRY* ALCAPI_CAPTURE_OPEN_DEVICE)(
